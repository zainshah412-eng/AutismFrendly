...
public class My_Cities_Model
{
    ...
    @Expose
    Country_PlaceDetail country;
    @SerializedName("translationsList")
    @Expose
    ...
    public String getPlaces_count() {
        return places_count;
    }

    public void setPlaces_count(String places_count) {
