...
public class ApplyFont {
    ...
    public final static String FONT_TYPEFACE = "CircularStd_Book.ttf";
    public final static String FONT_SEMIBOLDTYPEFACE = "CircularStd_Medium.ttf";
    public final static String FONT_TYPEFACE_Bold = "CircularStd_Bold.ttf";
    public final static String FONT_TYPEFACE_LIGHT = "CircularStd_Book.ttf";
