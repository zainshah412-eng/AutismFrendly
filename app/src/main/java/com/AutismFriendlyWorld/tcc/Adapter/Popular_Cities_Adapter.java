...
public class Popular_Cities_Adapter extends RecyclerView.Adapter<Popular_Cities_Adapter.MyViewHolder>
{
    ...
    public Popular_Cities_Adapter(List<My_Cities_Model> modelList,int type)
    {
    ...
    @Override
    public Popular_Cities_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_popularcites, parent, false);
        context = parent.getContext();
        return new Popular_Cities_Adapter.MyViewHolder(itemView);
    }

    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(Popular_Cities_Adapter.MyViewHolder holder, int position)
    {
