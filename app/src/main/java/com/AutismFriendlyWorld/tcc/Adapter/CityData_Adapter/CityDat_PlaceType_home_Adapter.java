...
public class CityDat_PlaceType_home_Adapter extends RecyclerView.Adapter<CityDat_PlaceType_home_Adapter.MyViewHolder>
{
    ...
    public CityDat_PlaceType_home_Adapter(List<Place_PlaceDetail> modelList,int type)
    {
        this.modelList = modelList;
        this.callType=type;
    }
    public CityDat_PlaceType_home_Adapter(Fragment fragment,List<Place_PlaceDetail> modelList,int type)
    {
        this.modelList = modelList;
        this.callType=type;
    ...
    @Override
    public CityDat_PlaceType_home_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_places_type_screen_cites, parent, false);
        context = parent.getContext();
        return new CityDat_PlaceType_home_Adapter.MyViewHolder(itemView);
    }

    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(CityDat_PlaceType_home_Adapter.MyViewHolder holder, int position)
    {
